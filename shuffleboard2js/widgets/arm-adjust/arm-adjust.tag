<arm-adjust>
    <svg width = '100%' height = "100%">
        ...
        <rect ref="upBtn" class = 'up-button' x = '50%' width="40%" height="40%" style="fill-opacity: 0;stroke-width:3;stroke:rgb(0,0,0)" />
        <rect ref="downBtn" class = 'down-button' x = '50%' y = '45%' width="40%" height="40%" style="fill-opacity: 0;stroke-width:3;stroke:rgb(0,0,0)" />
